        ...
        <div class="col-md-5 ">
            <form action="" method="GET">
                <div class="input-group mb-3 ">
                    ...
                    <button type="submit" class="btn btn-primary">Filtre par date</button>
                </div>
            </form>
        </div>
        <div class="col-md-5 ">
            <form action="" method="GET">
                <div class="input-group mb-3 ">
                    <input type="text" name="search" required value="" class="form-control" placeholder="Recherche">
                    <button type="submit" class="btn btn-primary">Filtre par Nom</button>
                </div>
            </form>
        </div>
    </div>
