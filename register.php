...
<body>
    ...
    <div class="container">
        <h1 class="mt-3">Fromulaire d'arregistrement</h1>
        <hr>
        ...
        <div class="form-group">
            <label for="type" class="col-sm-3 control-label">Selectionner le Type</label>
            <div class="col-sm-12">
                <select name="txt_role" class="form-control">
                    <option value="" selected="selected">- Type d'utilisateur -</option>
        ...
        <div class="form-group">
            <div class="col-sm-12 mt-3">
                <input type="submit" name="btn_register" class="btn btn-primary" style="width: 100%;" value="Inscrire">
            </div>
        </div>
