 ...
 <script src="https://unpkg.com/leaflet@1.7.1/dist/leaflet.js"
  ...
  <body onload="init()">
    ...
    <?php 
        ...
        // $now = date("Y-m- "); 
    // ?>
    <!-- <div class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200"></div> -->
    <form action="code.php" method="POST">
            ...
            <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                    ...
                    <label class="block text-sm">
                        ...
                        Enregistrer mon heure d'arrivé
                        </span>
                        <div class="mb-4 text-lg font-semibold text-gray-600 dark:text-gray-300"></div>
                            <div class="relative">
                                <input type="hidden" name="name" class="form-control"  value="<?=$data["username"];?>">
                                <input type="hidden" name="id" class="form-control"  value="<?=$data["id"];?>">
                                <input type="text" classe="ml-6" name="event_dt"  value="<?=$now;?>" readonly class="block w-full pl-18 mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray form-input"/>
                                <button type="submit" name="save_datetime" class="absolute inset-y-0 px-4 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-l-md active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">
                                    Enregistrer
                                </button>
                            </div>
                    </label>
            ...
            <div class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200"></div>
              <label class="block mt-4 text-sm">
                <span class="text-gray-700 font-semibold dark:text-gray-400">
                  Enregistrer mon heure de départ
                </span>
                <div class="mb-4 text-lg font-semibold text-gray-600 dark:text-gray-300"></div>
                <div class="relative text-gray-500 focus-within:text-purple-600">
                  ...
                  type="text" classe="ml-6" name="event_depart"  value="<?=$now;?>" readonly/>
                  <button type="submit" name="save_datetime_depart"
...
<!-- <body > -->
    ...
    <!-- <div id="map"></div>
     -->
      ...
      <div class="container px-6 mx-auto grid">
      <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">Géolocalisation</h2>
      <div class="px-4 mx-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
      <div id="map"></div>
            </div>
      </div>
